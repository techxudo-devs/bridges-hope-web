          ...
          <div className="w-full max-w-5xl rounded-xl bg-white p-5 md:p-8 shadow-2xl">
            ...
            {selectedPaymentMethod?.key === "whatsapp" ? (
              <button
                ...
                className="mx-auto mt-8 flex w-full max-w-2xl items-center justify-center gap-3 rounded-full bg-[#25D366] px-8 py-4 text-lg font-black text-white hover:opacity-90 transition-opacity"
              >
